                        ...
                        <div class="scrollbar-sidebar">
                            <div class="app-sidebar__inner">
                                <ul class="vertical-nav-menu">
                                    ...
                                    <li>
                                        <a href="NewAccount" class="mm-active">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <h3 class="card-title">IDCS Request New Account</h3>
                                                            ...
                                                            <c:forEach items="${listUser}" var="i" varStatus="list">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <button name="reject" value="reject" type="button"
                                                                                class="btn mr-2 mb-2 btn-danger"
                                                                                data-toggle="modal" data-target="#dialogModalReject">Reject</button>
                                                                        <button name="accept" value="accept" type="button" 
                                                                                class="btn mr-2 mb-2 btn-primary"
                                                                                data-toggle="modal" data-target="#dialogModalAccept">
                                                                            Accept
                                                                        </button>
                                                                    </td>
                                                                </tr>
...
<form action="NewAccount" method="POST">
    <div class="modal fade" id="dialogModalAccept" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0">Do you want create <input class="alertPopup" name="account"id="account"/> account?</p>
                    <input hidden  />
                </div>
    ...
    <!-- Modal reject-->
    <div class="modal fade" id="dialogModalReject" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0">Do you want Delete <input class="alertPopup" name="account" id="account1"/> account?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary">Save changes</button>
