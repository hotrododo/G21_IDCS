<%-- 
    Document   : poorActionView
    Created on : Dec 26, 2019, 2:49:22 AM
    Author     : mac
--%>
...
<html>
    <head>
        ...
        <title>404 not found, website in constructor</title>
        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    ...
                    <p class="subheading">Looks like the page you were looking for is no longer here. The website is under construction and we working hard to make something blown up!</p>
                </div>
            </div>
